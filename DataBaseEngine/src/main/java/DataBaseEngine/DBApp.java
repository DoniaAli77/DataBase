...
//				
//				FileInputStream file = new FileInputStream("..//DataBaseEngine//data//Tables.ser");
...
/**********************1- Student Table*******************************/
//				FileInputStream file0 = new FileInputStream("..//DataBaseEngine//data//Student0.ser");
...
//				}
//				System.out.println();
//				FileInputStream file1 = new FileInputStream("..//DataBaseEngine//data//Student1.ser");
...
//				}
//				System.out.println();
//				FileInputStream file2 = new FileInputStream("..//DataBaseEngine//data//Student2.ser");
...
//				FileInputStream file = new FileInputStream("..//DataBaseEngine//data//Location0.ser");
//				ObjectInputStream in = new ObjectInputStream(file);
...
//				FileInputStream file1 = new FileInputStream("..//DataBaseEngine//data//Events1.ser");
//				ObjectInputStream in1 = new ObjectInputStream(file1);
...
//				
//				
//				FileInputStream file10 = new FileInputStream("..//DataBaseEngine//data//Events2.ser");
...
//				}
//				FileInputStream file2 = new FileInputStream("..//DataBaseEngine//data//Events3.ser");
//				ObjectInputStream in2 = new ObjectInputStream(file2);
...
//				}
//				FileInputStream file3 = new FileInputStream("..//DataBaseEngine//data//Events4.ser");
...
//				}
//				
//				FileInputStream file31 = new FileInputStream("..//DataBaseEngine//data//Events5.ser");
...
//				}
////				
//				FileInputStream file9 = new FileInputStream("..//DataBaseEngine//data//Events6.ser");
...
//	}
	...
	public void init(){
		 try{
			 ...
			 if(getCSVSize()>1){
				 ...
				 FileInputStream("..//DataBaseEngine//data//Tables.ser");
				 ObjectInputStream in = new ObjectInputStream(file);
				 ...
				 "..//DataBaseEngine//data//Tables.ser");
	...
	public void createTable(String strTableName, String strClusteringKeyColumn,
		...
		try {
			...
			FileWriter fr = new FileWriter("..//DataBaseEngine//data//metadata.csv", true);
	...
	public void createBTreeIndex(String strTableName,String strColName) throws DBAppException
			{
				try{
					...
					FileReader fr2 = new FileReader("..//DataBaseEngine//data//metadata.csv");
					...
					FileWriter fr = new FileWriter("..//DataBaseEngine//data//metadata.csv", false);
...
//				System.out.println(bbb);
	...
	public static void insertRec(int indexinfiles, int indexinv, Object[] arrayOfData, ArrayList<String> files,
		...
		if (indexinfiles == files.size() && indexinv==0) {
			...
			FileOutputStream file1 = new FileOutputStream("..//DataBaseEngine//data//" + t.name + t.GetLastId() + ".ser");
			ObjectOutputStream out = new ObjectOutputStream(file1);
			out.writeObject(v);
			out.close();
			file1.close();
...
//////////////////////////////////Index Case //////////////////////////////////////////////////
	...
	public static ArrayList<String> FindFiles(String tablename) {
		...
		for (int i = 0; i < ids.size(); i++) {
			filenames.add("..//DataBaseEngine//data//" + tablename + ids.get(i) + ".ser");// complete path "student0"
		}
		return filenames;
	}
	...
	public int readingFromConfigFile(String string) throws IOException {
		...
		FileInputStream ip = new FileInputStream("..\\DataBaseEngine\\config\\DBApp.properties");
		prop.load(ip);
	...
	public static int getCSVSize() throws IOException {
		...
		try {
			...
			FileWriter fr = new FileWriter("..//DataBaseEngine//data//metadata.csv");
